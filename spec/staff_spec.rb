...
describe 'Restaurant::Staff' do
  ...
  describe '.get_id' do
    it 'returns a Restaurant::Staff instance given an id' do
  ...
  describe '#complete_order' do
    it 'returns the order number which was marked complete' do
  ...
  describe '#list_open_orders' do
    it 'returns Restaurant::Order instances for all open orders' do
      Benny = Restaurant::Staff.create_staff("Benny")
      Restaurant::Customer.create_customer("Sara")
  ...
  describe '#list_closed_orders' do
    it 'returns Restaurant::Order instances for all closed orders' do
      Benny = Restaurant::Staff.create_staff("Benny")
      Restaurant::Customer.create_customer("Sara")
      Restaurant::Customer.create_customer("Betsy")
      Restaurant::Order.create_order(1)
  ...
  describe '#list_all_orders' do
    it 'returns Restaurant::Order instances for all orders' do
      Benny = Restaurant::Staff.create_staff("Benny")
      Restaurant::Customer.create_customer("Sara")
      Restaurant::Customer.create_customer("Betsy")
      Restaurant::Order.create_order(1)
