...
describe 'Restaurant::Order' do
  ...
  describe '.create_order_delete_shopping_cart' do
    it 'creates a new order given a shopping_cart_id and deletes the shopping_cart and returns an order instance' do
  ...
  describe '#update_order_status' do
    it 'changes the status of an order to open or closed' do
      customer = Restaurant::Customer.create_customer("Crissy")
      shopping_cart_id = customer.create_shopping_cart.id
  ...
  describe '#read_order_foods' do
    it 'looks up order by id and returns a nested array with food ids and food quantities' do
      customer = Restaurant::Customer.create_customer("Crissy")
