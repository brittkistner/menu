...
describe 'Restaurant::Food' do
  ...
  describe '.add_food' do
    xit 'adds food to the food list given a name, price, and type_of_item and returns a food instance' do
      expect(Restaurant::Food.add_food("Coke", 2, "beverage")).to be_a(Restaurant::Food)
    end
  end

  describe '.get' do
    xit 'takes a food id and returns a food instance' do
  ...
  describe '.list' do
    xit 'lists all food on the food list' do
      Restaurant::Food.add_food("Coke", 2, "beverage")
